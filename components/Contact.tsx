          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-4 group">
              ...
              <div>
                ...
                <a
                  href="mailto:hrkshnagtm@gmail.com"
                  className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300"
                >
                  hrkshnagtm@gmail.com
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                {/* GitHub */}
                <a
                  href="https://github.com/Harikrishna-HG"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-gray-900 dark:bg-gray-700 rounded-lg flex items-center justify-center hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors group"
                  aria-label="GitHub"
                >
                  <svg
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-sky-500 dark:bg-sky-600 rounded-lg flex items-center justify-center hover:bg-sky-600 dark:hover:bg-sky-500 transition-colors group"
                  aria-label="Twitter"
                >
                  <svg
                    className="w-6 h-6 text-white"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-blue-700 dark:bg-blue-800 rounded-lg flex items-center justify-center hover:bg-blue-800 dark:hover:bg-blue-700 transition-colors group"
                  aria-label="LinkedIn"
                >
                  <svg
                    className="w-6 h-6 text-white"
